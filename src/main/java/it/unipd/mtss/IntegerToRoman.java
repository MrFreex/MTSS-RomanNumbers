...
public class IntegerToRoman {
  ...
  /**
   * Boundary to comply with project specification: numbers up to 1000
   */
   ...
   * @throws IllegalArgumentException if the number is less than 1 or greater than MAX_VALUE
   */
